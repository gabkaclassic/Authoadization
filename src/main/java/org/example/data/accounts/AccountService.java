        ...
        return repository
                ...
                .map(exists -> {
                    ...
                    if(exists)
                        ...
                        AccountValidator.validate(login, password, email, violations);
        ...
        return repository
                ...
                .map(account -> {
                    ...
                    if(account == null)
                        ...
                        if(newLogin != null)
                            AccountValidator.validLogin(newLogin, violations);
                        if(newPassword != null)
                            AccountValidator.validPassword(newPassword, violations);
                        if(newEmail != null)
                            AccountValidator.validEmail(newEmail, violations);
                    }
