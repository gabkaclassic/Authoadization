...
public class AccountValidator {
    ...
    public static boolean validPassword(String password, List<String> remarks) {
    ...
    public static boolean validLogin(String login, List<String> remarks) {
    ...
    public static boolean validEmail(String login, List<String> remarks) {
